...
abstract contract BaseStakingHooks is IStakingHooks, ERC165 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return interfaceId == ISTAKING_HOOKS_INTERFACE_ID || super.supportsInterface(interfaceId);
    }
     ...
     */
    function beforeUnstake(address user, uint256 stakeId, bytes calldata data) external virtual override {
     ...
     */
    function afterUnstake(address user, uint256 stakeId, bytes calldata data) external virtual override {
     ...
     */
    function _beforeUnstake(address user, uint256 stakeId, bytes calldata data) internal virtual {}

    /**
     * @dev Internal implementation of afterUnstake hook.
     */
    function _afterUnstake(address user, uint256 stakeId, bytes calldata data) internal virtual {}
}
